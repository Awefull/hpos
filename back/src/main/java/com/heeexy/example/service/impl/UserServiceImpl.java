...
public class UserServiceImpl implements UserService {
	...
	public JSONObject getInfo(JSONObject jsonObject) {
		...
		JSONObject jObject = userDao.getInfo(username);
		info.put("userInfo", jObject);
	 ...
	 */
//	@Override
//	public JSONObject updateEvaluate(JSONObject jsonObject) {
//		userDao.updateEvaluate(jsonObject);
//		return CommonUtil.successJson();
//	}
