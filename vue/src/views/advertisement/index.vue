<template>
  <div>
    ...
    <div class="md-section js-consult-form" style="background-color:#f7f7f7;"> 
            ...
            <div class="header">
                <div class="header-left">
                    <li class="dropdown head-dpdn">
                        <a style="color:black" class="dropdown-toggle"><i class="fa fa-gift" aria-hidden="true"></i>
                                广告位申请</a>
                    </li> 
                </div>
            </div>
        ...
        <h2 class="form-01__title">Advertisement</h2> 
        <form class="form-01__form"> 
        <el-row type="flex" class="row-bg">
            <el-col :span="24" width="200px">
        ...
        <el-row type="flex" class="row-bg">
            ...
            <el-col :span="10">
                <el-radio-group v-model="radio2" @change="changePrice">
            ...
            <el-col :span="10">                
                <a class="price pull-right" >{{ price }}</a>
                <a class="price pull-right">金额:</a>
            </el-col>
        </el-row>
        <el-row type="flex" class="row-bg">
            <el-col :span="5">
                <div class="form__end">                    
                    <el-upload
                        ...
                        <el-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">图片预览</el-button>
            ...
            <el-col :span="4">
                <div class="form__end">  
                    <el-button type="primary" @click="submitUpload">提交申请</el-button>
                </div>
            </el-col>
            <el-col :span="5">
                <div class="form__end">  
                    <el-button type="primary" @click="auditResults()">审核结果</el-button>
                </div>
            </el-col>
            <el-dialog title="广告位审核结果" :visible.sync="dialogFormVisible" style="display: none;" append-to-body="" >
                <el-form class="small-space" label-position="left" label-width="80px" style='width: 600px; margin-left:50px;margin-bottom:50px;'>
                  <el-table ref="filterTable" :data="resultsList" height="250" style="width: 1000px;margin-left:50px;">
                    <el-table-column prop="updateDate" label="申请日期" column-key="date">                 
                    </el-table-column>
                    <el-table-column prop="applicationDays" label="广告持续时间">
                      <template slot-scope="scope">
                        <p>{{scope.row.applicationDays}}天</p>
                      </template>
                    </el-table-column>
                    <el-table-column prop="auditResults" label="审核结果">
                      <template slot-scope="scope">
                        <p v-if="scope.row.auditResults == 1">审核通过</p>
                        <p v-if="scope.row.auditResults == 0">正在审核</p>
                        <p v-if="scope.row.auditResults == 2">审核不通过</p>
                      </template>
                    </el-table-column>
                  </el-table>
                </el-form>
...
export default {
  ...
  methods: {
    ...
    beforeUpload() {
        this.$message.success("以申请，等待审核结果");
    }, 
    ...
    submintAdvertisement() {
        this.$message.success("提交成功");
    },
    getAdvertisementMessage() {
        this.advertisementMessage.unitName = this.$root.unitName;
        this.advertisementMessage.applicationDays = this.radio2*10;
        this.advertisementMessage.amount = this.price;
    ...
    auditResults() {
        ...
        this.advertisementMessage.unitName = this.$root.unitName;
        this.api({
          url: "/attachments/getResultsList",
          method: "post",
          data: this.advertisementMessage
        }).then(data => {
  ...
  components: {ScrollBar,SNavBar,CNavBar},
};
</script>
