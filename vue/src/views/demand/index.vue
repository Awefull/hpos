<template>
  <div>
   ...
   <!-- Section --> 
    <div class="md-section js-consult-form" style="background-color:#f7f7f7;"> 
      <div class="container">
          <div class="header">
            <div class="header-left">
                <li class="dropdown head-dpdn">
                    <a style="color:black" class="dropdown-toggle"><i class="fa fa-cloud-upload" aria-hidden="true"></i>
                            发布需求</a>
                </li> 
            </div>
           </div>
        <!-- form-01 --> 
        <div class="form-01 consult-form js-consult-form__content" id="form01" style="bottom:auto;"> 
        <h2 class="form-01__title">发布您的需求</h2> 
        <form class="form-01__form" :model="demandForm" ref="demandForm"> 
            <div class="row"> 
                <!-- <div class="col-md-1">
                            <a class="type_select">类型:</a> 
                        </div> -->
                <div class="row">        
                    ...
                    <div class="col-md-10">
                        <input type="text" name="title" placeholder="例如：开发一个课外阅读微信公众号" v-model="demandForm.projectName"/> 
                    </div>
                </div>
                <div class="row">        
                    <div class="col-md-2"> 
                    ...
                    <div class="col-md-10">
                        <textarea rows="2" name="projectDescription" placeholder="备注:" v-model="demandForm.projectDescription"></textarea>  
                    </div>
                </div>
                <div class="row">        
                    <div class="col-md-2"> 
                    ...
                    <div class="col-md-10">
                        <select v-model="demandForm.projectType" @change="changedemandType($event)"> 
                            <option v-for="(item,index) in projectTypeList" :key="index"  :value='item'>{{item}}</option>   
                        </select> 
                    </div>
                </div>
                <div class="row">        
                    ...
                    <div class="col-md-10">
                        <select v-model="demandForm.recruitmentRole" @change="changedemandType($event)"> 
                            <option v-for="(item,index) in recruitmentRoleList" :key="index"  :value='item'>{{item}}</option>   
                        </select> 
                    </div>
                </div>
                <div class="row">        
                    ...
                    <div class="col-md-10">
                        <select v-model="demandForm.demandType" @change="changedemandType($event)"> 
                            <option v-for="(item,index) in demandTypeList" :key="index"  :value='item'>{{item}}</option>   
                        </select> 
                    </div>
                </div>
                <div class="row">        
                    ...
                    <div class="col-md-10">
                        <input type="text" name="projectCycle" placeholder="单位：天"  v-model="demandForm.projectCycle"/> 
                    </div>
                </div>
                <div class="row">        
                    <div class="col-md-2"> 
                    ...
                    <div class="col-md-10">
                        <input type="text" name="budget" placeholder="注：支付首款为预算的10%"  v-model="demandForm.projectBudget"/> 
                    </div>
                </div>
                <div class="row">        
                    <div class="col-md-2"> 
                    ...
                    <div class="col-md-10">
                        <input type="text" name="projectDemand" placeholder="例如：运用python" v-model="demandForm.projectDemand"/> 
                    </div>
                </div>
                <!-- <div class="col-md-4"> 
                <select> <option value="1">企业用户</option> <option value="2">工作室用户</option> </select> 
                </div> 
                <div class="col-md-4"> 
                <select> <option value="1">30天</option> <option value="2">60天</option> <option value="2">90天</option> <option value="2">120天</option> </select> 
                </div> 
                <div class="col-md-4"> 
                <input type="email" name="email" placeholder="Your Email（必填）" /> 
                </div>  -->
            </div> 
            <div class="form__end"> 
                <el-row>  
                    ...
                    <el-upload
                            ...
                            name="multipartfiles"
                            ref="upload"
                            action="api/attachments/saveAttachments"
                            :data="advertisementMessage"                   
                            ...
                            :auto-upload="true">
                            <el-button slot="trigger" size="medium" type="primary">上传文件</el-button>                      
                        ...
                        <el-col :span="6"><div>
                            <el-button style="margin-left: 10px;" size="medium" type="success" @click="releaseDemand">发布需求</el-button>
                        </div></el-col>   
                </el-row>
            </div> 
        </form> 
...
export default {
    data() {
        return {
            ...
            demandTypeList:["项目外包","人力外包"],
            projectTypeList:["Web网站","App开发","微信公众号","HTML5应用","小程序"],
            recruitmentRoleList:["项目经理","产品经理","设计师","Android开发","iOS开发","前端开发","后端开发","全栈开发",
            "应用开发","开发团队","测试工程师"],
        };
    },
    computed: {
    ...
    components: {ScrollBar,CNavBar},
    methods: {
        changedemandType() {
            this.demandForm.demandType = event.target.value;
        },
        releaseDemand() {            
            let _vue = this;
            this.demandForm.unitName = this.$root.unitName;
            if (Number.isInteger(parseFloat(this.demandForm.projectCycle)) === false)
            {
                this.$message.error("项目周期必须为整数！");
                return 
            } else if (Number.isInteger(parseFloat(this.demandForm.projectBudget)) === false) {
                this.$message.error("项目金额必须为数字！");
                return 
            } else{
                this.api({
        ...
        addNotRecruitrd() {
            this.demandForm.unitName = this.$root.unitName;
            this.api({
            url: "/companyProjectManagement/addNotRecruitedProject",
            method: "post",
            data: this.demandForm
            }).then(() => {
                this.$message.success("需求发布成功!");
                this.$message.success("即将跳转到项目招募页面!");
                this.Countdown();
            })
        },
        Countdown() {
            ...
            if(!this.timer) {
                ...
                this.timer = setInterval(()=>{
                    if(this.count > 0 && this.count <= TIME_COUNT){
                        ...
                        this.timer = null;
                        this.$router.push({path:'/companyManageUnrecruited'});
                    }
                },1000)
            }
        }
